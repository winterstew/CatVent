...
print(f"Connected to {os.getenv('CIRCUITPY_WIFI_SSID')} at {wifi.radio.addresses[0]}")
...
vocindex_feed = "vocindex"
proximity_feed = "proximity"
illuminance_feed = "illuminance"
...
def connected(client, userdata, flags, rc):
    ...
    print(f"                          Listening for topic changes on {speed_feed}")
    # Subscribe to all changes on the speed_feed.
